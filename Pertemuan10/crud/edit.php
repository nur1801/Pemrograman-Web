    ...
    <div class="container">
        ...
        <form action="proses2.php?aksi-ubah" method="post">
            ...
            <div class="radio-group">
                <input type="radio" name="jenis kelamin" value="L" id="laki" <?php if ($row['jenis_kelamin'] === 'L') 
                echo 'checked'; ?> required>
                <label for="laki">Laki-laki</label>
                <input type="radio" name="jenis kelamin" value="p" id="perempuan" <?php if ($row['jenis_kelamin'] === 'P') 
                echo 'checked'; ?> required> 
